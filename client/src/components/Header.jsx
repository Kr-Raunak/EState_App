...
export default function Header() {
  ...
  return (
    <header className='bg-[#1E3A8A] shadow-md fixed w-full }'  >
      <div className='flex justify-between items-center max-w-6xl mx-auto p-3'>
        ...
        <ul className='flex gap-4'>
          <Link to='/' className="flex items-center">
            <li className='hidden sm:inline items-center text-white hover:text-[#FF6B35] hover:underline px-1'>
              HOME
            </li>
          </Link>
          <Link to='/create-listing' className="flex items-center">

            <div className='flex-wrap items-center text-white hover:text-[#FF6B35] bg-orange-400 p-2 rounded-md shadow-md hover:bg-slate-100'>
          ...
          <Link to='/profile' className="flex items-center">
            ...
            />
              ...
              <li className=' hover:text-[#FF6B35] text-white hover:font-semibold'> SIGN IN</li>
            )}
          </Link>
